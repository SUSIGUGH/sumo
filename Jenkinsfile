    ...
    stages{
        ...
        stage("Execute Terraform"){
            steps{
                ...
                sh 'ssh ec2-user@172.31.4.239 "cd terraform && terraform output | grep workerprvip01 | cut -d"=" -f2"'
                sh 'ssh ec2-user@172.31.4.239 "cd terraform && terraform output | grep workerprvip02 | cut -d"=" -f2"'
